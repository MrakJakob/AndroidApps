...
object Mapper {
    ...
    fun mapRecipeDetailsToRecipeDetailsDto(aux: RecipeDetails): RecipeDetailsDTO {

        var dto = RecipeDetailsDTO(idDrink = aux.idDrink!!, strDrink = aux.strDrink!!, strCategory = aux.strCategory!!, strInstructions = aux.strInstructions!!, strDrinkThumb = aux.strDrinkThumb!!,
        strIngredient1 = aux.strIngredient1!!,
                strIngredient2 = aux.strIngredient2!!,
        strIngredient3 = aux.strIngredient3!!,
                strIngredient4 = aux.strIngredient4!!,
        strIngredient5 = aux.strIngredient5!!,
                strIngredient6 = aux.strIngredient6!!,
        strIngredient7 = aux.strIngredient7!!,
                strIngredient8 = aux.strIngredient8!!,
        strIngredient9 = aux.strIngredient9!!,
                strIngredient10 = aux.strIngredient10!!,
        strIngredient11 = aux.strIngredient11!!,
                strIngredient12 = aux.strIngredient12!!,
        strIngredient13 = aux.strIngredient13!!,
                strIngredient14 = aux.strIngredient14!!,
        strIngredient15 = aux.strIngredient15!!,
                strMeasure1 = aux.strMeasure1!!,
        strMeasure2 = aux.strMeasure2!!,
                strMeasure3 = aux.strMeasure3!!,
        strMeasure4 = aux.strMeasure4!!,
                strMeasure5 = aux.strMeasure5!!,
        strMeasure6 = aux.strMeasure6!!,
                strMeasure7 = aux.strMeasure7!!,
        strMeasure8 = aux.strMeasure8!!,
                strMeasure9 = aux.strMeasure9!!,
        strMeasure10 = aux.strMeasure10!!,
                strMeasure11 = aux.strMeasure11!!,
        strMeasure12 = aux.strMeasure12!!,
                strMeasure13 = aux.strMeasure13!!,
        strMeasure14 = aux.strMeasure14!!,
                strMeasure15 = aux.strMeasure15!!,
        strImageSource = aux.strImageSource!!, strDrinkAlternate = aux.strDrinkAlternate!!, strAlcoholic = aux.strAlcoholic!!, strCreativeCommonsConfirmed = "", strIBA = aux.strIBA!!, strImageAttribution = "", strInstructionsDE = "", strInstructionsFR = "", strInstructionsIT = "", strTags = aux.strTags!!, dataModified = "")
...
//    }
    ...
    fun mapRecipeDetailsToRecipeSummaryDTO(recipe: RecipeDetails): RecipeSummaryDTO {
        if (recipe.strImageSource != null){
            return RecipeSummaryDTO(recipe.strDrink!!, recipe.strImageSource!!, recipe.idDrink!!)
        }
        return RecipeSummaryDTO(recipe.strDrink!!, "", recipe.idDrink!!)
